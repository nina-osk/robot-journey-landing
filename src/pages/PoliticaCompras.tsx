...
const PoliticaCompras = () => {
  return (
    <div className="min-h-screen bg-[#050505] text-gray-300">
      <Seo
        title="Política de Compras, Cancelaciones y Reembolsos | RobotsConsultant"
        description="Condiciones de compra, cancelación y reembolso de los servicios y productos de RobotsConsultant."
        path="/politica-compras"
      />
      <Navbar />
